...
def get_rover_rt_tasket():
    # task order: navigation, camera, sensor, coretemp, location

    n_rt_task = 5

    rt_task_tid = ['navigation', 'camera', 'sensor', 'coretemp', 'location']

    wcets = [240.0, 1120.0, 186.0, 209.0, 193.0]
    periods = [500, 5000, 1000, 1500, 2000]
